  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (typeof handler === "function") {
        ...
        if (success) {
          toast.success("Congrats all tests has passes", {
            position: "top-center",
            autoClose: 3000,
            theme: "dark",
          });
              ...
              >
                <div className="flex flex-wrap items-center gap-y-4 ">
                  <div
                    ...
                    } font-medium items-center transition-all focus:outline-none inline-flex bg-dark-fill-3 hover:bg-dark-fill-2 rounded-lg relative px-3 py-0.5 whitespace-nowrap cursor-pointer`}
                  >
                    Case {index + 1}
                  </div>
                </div>
